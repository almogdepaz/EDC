...
check "audit fixtures cover simplification tags and antipattern overlap" "$(rg -q 'stdlib|native|yagni|cargo cult|shooting the messenger|boat anchor' "$FIXTURES/audit" && echo 1 || echo 0)"
