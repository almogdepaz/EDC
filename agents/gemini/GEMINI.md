...
Activate the `edc-context` skill. Analyze the full codebase. Write output to `.context/full-context.md`. Then split into `context.md` (overview) + `.context/{module}.md` (per-module) + `.context/issues.md` (problems) + `.context/.meta.json`.
