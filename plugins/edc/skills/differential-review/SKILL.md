...
- If `.context/context.md` exists, load it for architecture overview and module map
- Map changed files to modules, load relevant `.context/{module}.md`
- Load `.context/issues.md` to check if changes touch known issues
...
- Change touches code flagged in `.context/issues.md`
