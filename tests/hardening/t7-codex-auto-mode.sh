...
# Test fixtures stub each skill with a one-line marker, so build/update
# match disjointly here even though the real skills overlap.
...
# Review prompts are now structured: "TASK FILE: <path>" header line.
