...
- Optional research tests must cover available, broken, hanging, absent, repository-path-rejected, and caller-preseeded states while proving one immutable coordinator capability decision, review-all child inheritance, no installation/hard dependency, immediate native fallback, assigned-scope limits, uncertainty, and manifest authority.
